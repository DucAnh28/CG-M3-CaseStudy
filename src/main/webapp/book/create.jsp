    ...
    <div class="table-responsive">
        ...
        <form method="post" action="/books?action=create">
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" name="name" placeholder="name" aria-label="Recipient's username" aria-describedby="basic-addon2">
                ...
                <input type="text" class="form-control" name="price" placeholder="price" aria-label="Recipient's username" aria-describedby="basic-addon2">
                <input type="text" class="form-control" name="image" placeholder="image" aria-label="Recipient's username" aria-describedby="basic-addon2">
                <input type="text" class="form-control" name="description" placeholder="description" aria-label="Recipient's username" aria-describedby="basic-addon2">
